          ...
          destinations: const [
            ...
            NavigationDestination(
              icon: DescribedFeatureOverlay(
                ...
                tapTarget: const Icon(Icons.menu_book_outlined),
              ...
              selectedIcon: const Icon(Icons.menu_book, color: Color(0xFF0F3A26)),
              label: 'Al-Qur\'an',
            ),
            ...
            NavigationDestination(
              icon: DescribedFeatureOverlay(
                ...
                tapTarget: const Icon(Icons.mosque_outlined),
              ...
              selectedIcon: const Icon(Icons.mosque, color: Color(0xFF0F3A26)),
              label: 'Ibadah',
            ),
            NavigationDestination(
